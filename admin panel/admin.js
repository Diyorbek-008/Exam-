...
function chiqar(data) {
    ...
    data.forEach((item) => {
        ...
        tr.innerHTML = `
            ...
            <td>${item.Yili}</td>
            <td><img src=${item.rasm} width="80px"/> </td>
            <td><a href=${item.link}>Ko'rish</a></td>
            <td>
                <div class="amallar">
...
form.addEventListener("submit", (e) => {
    ...
    let newPerson = {
        ...
        KitobNomi: document.getElementById("KitobNomi").value,
        Yozuvchisi: document.getElementById("Yozuvchisi").value,
        rasm: URL.createObjectURL(imageInput.files[0]),
        Yili: document.getElementById("Yili").value
    }
